...
<body>
	<form method="post" action="UpdateMemberInfoOK.do">
		...
		<div>
			<div>주소</div>
			<input type="text" id="postcode" name = "postNum" placeholder="우편번호" value = '${member.postNum}'>
			...
			<span id="guide" style="color: #999; display: none"></span> <input
				type="text" id="detailAddress" placeholder="상세주소" name = 'detailAddress' value = '${member.detailAddress}'
		...
		<button>정보수정</button>
		<a href='loginafter.do'><button type='button'>취소</button></a>
	</form>
