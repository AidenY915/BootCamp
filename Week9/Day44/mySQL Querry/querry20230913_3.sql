...
CREATE TABLE PRODUCT22(PRODUCT_CODE CHAR(4) NOT NULL, PRODUCT_NAME VARCHAR(30), MAKER_CODE CHAR(4), FOREIGN KEY(MAKER_CODE) REFERENCES MAKER2(MAKER_CODE));
...
INSERT INTO PRODUCT22 VALUES('P003', '농구화', 'M003');
