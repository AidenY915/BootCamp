...
public class UserDao {
	...
	public void insertUser(UserDto dto) {
		String insertUserQuery = "INSERT INTO " + TABLE + " VALUES(?,?,?,?)";
		try(Connection conn = ds.getConnection();
				PreparedStatement insertUserStmt = conn.prepareStatement(insertUserQuery)){
			insertUserStmt.setString(1, dto.getUserName());
			insertUserStmt.setInt(2, dto.getUserAge());
			insertUserStmt.setString(3, dto.getUserGender());
			insertUserStmt.setString(4, dto.getUserEmail());
